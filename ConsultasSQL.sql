...
SELECT nombre, precio, precio * 1.13 AS dolares FROM producto

--5.Lista el nombre de los productos, el precio en euros y el precio en dólares estadounidenses (USD). Utiliza los siguientes alias para las columnas: nombre de producto, euros, dólares.
SELECT nombre AS 'nombre de producto', precio AS euros, precio * 1.13 AS dolares FROM producto
...
SELECT * FROM `fabricante` WHERE codigo =1 OR codigo = 3 OR codigo =5
...
SELECT * FROM `producto` WHERE `precio` >=180 GROUP BY `precio` DESC, `nombre` ASC
